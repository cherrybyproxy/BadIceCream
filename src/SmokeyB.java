...
public class SmokeyB extends Rectangle {
	...
	public Image up, down1, down2, left, right;

	// constructor creates player 2 at given location with given dimensions, and the
	// icon
	public SmokeyB(int x, int y, int num) {
		super(x, y, 40, 40);

		down1 = Toolkit.getDefaultToolkit().getImage("bdown1.png"); 
		down2 = Toolkit.getDefaultToolkit().getImage("bdown2.png"); 
		up = Toolkit.getDefaultToolkit().getImage("bback.png"); 
		left = Toolkit.getDefaultToolkit().getImage("bleft.png");
		right = Toolkit.getDefaultToolkit().getImage("b-right.png"); 
